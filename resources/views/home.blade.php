  ...
  <header id="header">
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto"><img src="img/logo.png" height="30" width="30" style="margin: -5px 10px 0px 0px;">O4HK ltd</a></h1>
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{ route('logout') }}"
                           onclick="event.preventDefault();
                                         document.getElementById('logout-form').submit();" style="color: black; text-align: center; padding: 2px 0px;">
                            {{ __('Logout') }}
                        </a>
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p>We make quality sweater for winter time.</p>
    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header">
          <h3>About Us</h3>
          <p>October 04 Ltd. is developing and maintaining its standard in order to ensure continuous progress.</p>
        </header>
        ...
        <div class="skills-content">
          ...
          <div class="progress">
            <div class="progress-bar bg-success" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
              <span class="skill">Sweaters <i class="val">100%</i></span>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-card">Sweaters</li>
    ...
    <section id="clients" class="wow fadeInUp">
      <div class="container">
        ...
        <div class="owl-carousel clients-carousel">
          <a target="_blank" href="https://www.didriksons.com/en"><img src="img/clients/client-1.png" alt="" style="margin-top: 20px; background: rgba(155, 155, 150, 0.3); border-radius: 20%;"></a>
          <a target="_blank" href="https://www.backcountry.com/"><img src="img/clients/client-2.png" alt="" style="background: rgba(255, 155, 150, 0.3); border-radius: 20%;"></a>
          <a target="_blank" href="https://halti.com/"><img src="img/clients/client-3.png" alt="" style="margin-top: 17px; background: rgba(124, 255, 150, 0.3); height: 60px; border-radius: 20%;"></a>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp">
            <div class="member">
              <img src="img/team-1.jpg" class="img-fluid" alt="ceo" style="height: 255px;">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Mohammed <br>Taufique Ahsan</h4>
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="member">
              <img src="img/team-4.jpg" class="img-fluid" alt="" style="height: 255px;">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Mostofa Kamal <br>Emon</h4>
                  <span>Chief of IT</span>
                  <div class="social">
                    <a target="_blank" href=""><i class="fa fa-twitter"></i></a>
                    <a target="_blank" href="https://www.facebook.com/mkemon13"><i class="fa fa-facebook"></i></a>
                    <a target="_blank" href=""><i class="fa fa-google-plus"></i></a>
                    <a target="_blank" href=""><i class="fa fa-linkedin"></i></a>
                  </div>
                </div>
