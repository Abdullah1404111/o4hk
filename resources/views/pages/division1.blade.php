                ...
                <div id="testimonial-slider" class="owl-carousel">
                    <div class="testimonial">
                        ...
                        <div class="testimonial-content">
                            <div class="pic"  id="font"><img src="img/members/division 1/Mamun.jpg" class=""alt="Mamun" id="myImg"></div>
                            <h3 class="title" id="title">Mr. Mamun</h3>
                    ...
                    <div class="testimonial">
                        ...
                        <div class="testimonial-content">
                            <div class="pic"  id="font"><img src="img/members/division 1/Jakia.jpg" class=""alt="Jakia" id="myImg1"></div>
                            <h3 class="title" id="title">Mr. Mamun</h3>
