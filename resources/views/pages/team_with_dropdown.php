...
<!--    
      <h1 class="teams">O͆u͆r͆ T͆e͆a͆m͆ 🅾🆄🆁 🆃🅴🅰🅼</h1>-->
       <h1 class="teams"> 🅾🆄🆁 🆃🅴🅰🅼</h1>
         <div class="row">
        <div class="col-lg-12">
          <ul id="portfolio-flters" style=" background:url(https://i.imgur.com/MJAkxbh.png)!important;height:60px;" >
<!--            <li data-filter="*" class="filter-active">All</li>-->
            <li data-filter=".filter-app">Management</li>
<!--            <li data-filter=".filter-card">Merchandising & P.D</li>-->
             <li class="dropdown">
...
-->
        ...
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempore rem quia ipsa optio error est ea quisquam. Possimus magnam corporis quaerat ullam veniam pariatur facere.
