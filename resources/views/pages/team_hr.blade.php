                ...
                <div id="testimonial-slider" class="owl-carousel">
                    <div class="testimonial">
                        ...
                        <div class="testimonial-content">
                            <div class="pic"><img src="img/members/dirhan copy.jpg" class=""alt="Dirhan" id="myImg"></div>
                            <h3 class="title" id="title">H.M. Dirhanul Azim</h3>
                          ...
                          <img class="modal-content" id="img01">
                           <div id="caption"></div>
                            ...
                            <button class="details btn">HR &amp; Admin</button>
