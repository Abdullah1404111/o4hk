...
<div class="dropdown-menu" style="height: 30px;">
    <ul id="portfolio-flters">
        ...
        <li data-filter=".Merch" class="dropdown-item" style="margin: 0px; padding:5px;">Merchandising & P.D</li>
         <li data-filter=".qaa" class="dropdown-item" style="margin: 0px; padding:5px;">QAA</li>
         <li data-filter=".sample" class="dropdown-item" style="margin: 0px; padding:5px;">R & D</li>
         <!-- <li data-filter=".filter-sew" class="dropdown-item" style="margin: 0px; padding:5px;">Sew Free</li> -->
         <li data-filter=".hr" class="dropdown-item" style="margin: 0px; padding:5px;">Accounts,HR & Admin</li>
    </ul>
</div>
</div>
