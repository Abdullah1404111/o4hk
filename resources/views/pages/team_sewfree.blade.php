                ...
                <div id="testimonial-slider" class="owl-carousel">
                    <div class="testimonial">
                        ...
                        <div class="testimonial-content">
                            <div class="pic"><img src="img/members/Tanvir Islam.png" class=""alt="" id="myImg"></div>
                            <h3 class="title" id="title">Tanvir Ahmed</h3>
                          ...
                          <img class="modal-content" id="img01">
                           <div id="caption"></div>
                            ...
                            <button class="details btn"> Production Control &amp; Product Development</button>
