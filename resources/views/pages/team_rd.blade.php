                ...
                <div id="testimonial-slider" class="owl-carousel">
                    <div class="testimonial">
                        ...
                        <div class="testimonial-content">
                            <div class="pic"><img src="img/members/Ali Akbar.jpg" class=""alt="ali" id="myImg"></div>
                            <h3 class="title" id="title">Md. Ali Akbar</h3>
                          ...
                          <img class="modal-content" id="img01">
                           <div id="caption"></div>
                            ...
                            <button class="details btn">Pattern Maker</button>
                     ...
                     <div class="testimonial">
                        ...
                        <div class="testimonial-content">
                            <div class="pic"><img src="img/members/Dipak Chandra Singha.jpg" class=""alt="dipak" id="myImg"></div>
                            <h3 class="title" id="title">Dipak Barua</h3>
                            <div id="myModal" class="modal">
                          <span class="close">&times;</span>
                          <img class="modal-content" id="img01">
                           <div id="caption"></div>
